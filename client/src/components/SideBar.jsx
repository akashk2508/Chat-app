    ...
    <div className={`bg-[#8185B2]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${selectedUser ? "max-md:hidden" : ''}`}>
      <div className='pb-5'>
        <div className='flex justify-between items-center'>
            <img src={assets.anid_logo_big} alt="logo" className='max-w-40 h-13'/>
            <div ref={menuRef} className='relative py-2 group'>
                ...
                <div
                    className={`absolute top-full right-0 z-50 w-32 p-5 rounded-md bg-[#282142] border border-gray-600 text-gray-100 ${showMenu ? "block" : "hidden"}`}
                >
